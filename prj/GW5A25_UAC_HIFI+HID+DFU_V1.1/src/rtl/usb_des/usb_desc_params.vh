...
//BOS
localparam bit [15:0] DESC_BOS_ADDR = DESC_HIDRPT_ADDR + DESC_HIDRPT_LEN;
localparam bit [15:0] DESC_BOS_LEN  = 16'd33;

// 字符串描述符地址与长度
localparam bit [15:0] DESC_STRLANG_ADDR     = DESC_BOS_ADDR + DESC_BOS_LEN;
